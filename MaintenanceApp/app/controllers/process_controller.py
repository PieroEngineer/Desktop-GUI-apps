...
class ProcessController:
    ...
    def start_processing(self): # Thread starter
        ...
        if current_input_path and current_output_path:
            ...
            self.view.text_frame.add_line('🏗️  Extrayendo datos, demorará dependiendo del tamaño...')## Change it by a loading bar time-depended
...
#----Functions connected----
    ...
    def show_summarize(self, nms_dfs):
        self.view.text_frame.add_line("    🗃️  La data está lista y se está subiendo, no cerrar el programa hasta que culmine")
    ...
    def when_df_to_excel_completed(self):
        self.view.text_frame.add_line('👋  Operación terminada, los datos han sido tratados y guardados en las rutas especificadas por el usuario ✅')
